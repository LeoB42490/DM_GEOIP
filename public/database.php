...
function checkFrenchIPV4($ip_addressINT)
{
    global $bdd;
...
function checkFrenchIPV6($ip_addressINT)
{
    global $bdd;
    $sRequete = 'SELECT country_code FROM ipv62location WHERE ip_from <= :ip_addressINT AND ip_to >= :ip_addressINT LIMIT 1';
    $stmt = $bdd->prepare($sRequete);
